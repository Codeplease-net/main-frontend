...
export default function DotsLoader({size}: {size: number}) {
  return (
    <div className={`flex items-center justify-center w-${size} h-${size} bg-background/60 backdrop-blur-md rounded-2xl border border-white/10 shadow-xl`}>
      <div className="flex items-center gap-2 px-4 py-3">
        {/* Animated dots with pulsing and scaling effects */}
