...
export default function MySubmissionsTab({ submissions, onSubmissionClick }: { submissions: SubmissionDetailProps[] | undefined, onSubmissionClick: (submission: SubmissionDetailProps) => void }) {
