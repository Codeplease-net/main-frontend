      ...
      <CardContent className="p-0">
        ...
        >
          ...
          >
            ...
            {!loading && (
              <div className="flex flex-col h-[calc(100vh-9rem)] overflow-auto bg-dot-pattern p-6">
          ...
          >
            {loading && (
             ...
             {!loading && (<div className="flex flex-col h-[calc(100vh-9rem)] overflow-auto bg-dot-pattern p-6">
